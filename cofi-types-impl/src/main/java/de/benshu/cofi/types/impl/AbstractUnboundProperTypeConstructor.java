...
public abstract class AbstractUnboundProperTypeConstructor<X extends TypeSystemContext<X>, U extends TypeConstructorMixin<X, ?, ? extends ProperTypeMixin<X, ?>>, T extends ProperType>
